...
class SharedLinear(nn.Linear, SharedLoRALayer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        nn.Linear.__init__(self, in_features, out_features, **kwargs)
        SharedLoRALayer.__init__(self, r=r, lora_alpha=lora_alpha, lora_dropout=lora_dropout,
                           merge_weights=merge_weights)
...
if __name__ == '__main__':
    ...
    out1 = linear1(input)
    out2 = linear2(input)
    print(id(linear1.lora_A) == id(linear2.lora_A))
    print(id(linear3.lora_A) == id(linear4.lora_A))
    print(id(linear3.lora_A) == id(linear2.lora_A))
    print(id(linear3.lora_A) == id(linear2.lora_A))
